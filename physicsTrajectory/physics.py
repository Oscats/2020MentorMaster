...
class PhysicsEngine:
    ...
    def update_sim(self, now, tm_diff):
        ...
        self.frontRightEncoderDistance += self.drivetrain.wheelSpeeds.frontRight*tm_diff
        self.rearRightEncoderDistance += self.drivetrain.wheelSpeeds.rearRight*tm_diff

        self.frontLeftEncoder.setCount(
            int(self.frontLeftEncoderDistance * self.encoderDistanceCalculation)
        )
        self.rearLeftEncoder.setCount(
            int(self.rearLeftEncoderDistance* self.encoderDistanceCalculation)
        )
        self.frontRightEncoder.setCount(
            int(self.frontRightEncoderDistance* self.encoderDistanceCalculation)
        )
        self.rearRightEncoder.setCount(
            int(self.rearRightEncoderDistance* self.encoderDistanceCalculation)
        )
